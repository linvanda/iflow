...
ft p                              将所有项目的所有当前迭代的特性分支合并到生产分支
ft p vmember member-center        将vmember和member-center项目的当前迭代的所有特性分支合并到生产分支
...
del branch_pattern                      删除匹配branch_pattern正则的分支，同时删除远程相应分支
del --no-remote branch_pattern          仅删除本地分支，不删除远程的
